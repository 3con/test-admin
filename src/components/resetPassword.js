...
import { cyan500, pinkA200, fullWhite } from 'material-ui/styles/colors';

import { Notification, translate, userLogin as userLoginAction } from 'admin-on-rest';

import logo from '../core/images/pablo.png'; 
                            ...
                            <div style={styles.form}>
                                <div style={styles.input} >
                                    <Field
                                        ...
                                        floatingLabelText={translate('aor.auth.currentPassword')}
                                    />
                                </div>
                                <div style={styles.input} >
                                    <Field
                                        name="newPassword"
                                        component={renderInput}
                                        floatingLabelText={translate('aor.auth.newPassword')}
                                        type="password"
                                    />
                                </div>
                                <div style={styles.input}>
                                    <Field
                                        ...
                                        component={renderInput}
                                        floatingLabelText={translate('aor.auth.confirmPassword')}
                                        type="password"
                                    />
                                </div>
                            </div>
